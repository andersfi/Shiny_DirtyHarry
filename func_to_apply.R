...
translate <- function(object,translation_to_apply){
  ...
  if (translation_to_apply=="translation_table.csv"){
...
translate_check <- function(object,translation_to_apply,subject){
  ...
  if (length(value_not_in_translation)>0){
    return(paste("value not mentioned in translation to",subject,":", value_not_in_translation))
  }
